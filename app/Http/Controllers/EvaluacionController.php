...
class EvaluacionController extends Controller{
    ...
    public function index(Request $request){
        ...
        if($datosPeriodo=="[]"){
            ...
            if($comisiones=="[]"){
                return view('evaluacion.index')->with('comisiones',$comisiones)->with('academicos',$academicos)->with('color',$color)->with('facultadUsuario',$facultadUsuario)->with('yaEvaluados',$yaEvaluados)->with('Mensaje','No Existen Comisiones Configuradas para esta Facultad');
            }else{
